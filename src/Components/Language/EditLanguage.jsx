  ...
  useEffect(() => {
    const fetchLanguage = async () => {
      try {
        ...
        data.deletestatus =
          data.deletestatus !== undefined ? data.deletestatus : false; // Ensure deletestatus is present
        setInitialValues(data);
        form.setFieldsValue(data);
        setLanguageName(data.programingname); // Cập nhật tên của Programming Language
        setLoading(false);
      } catch (error) {
      ...
      >
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: t("Please input Program Language Name!"),
            },
          ]}
        >
          <Input />
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: t("Please input Program Language Type!"),
            },
          ]}
        >
          <Select
