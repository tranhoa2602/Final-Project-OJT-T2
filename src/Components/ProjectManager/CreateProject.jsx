...
import { Modal, Form, Input, Button, DatePicker, Select, message, Space } from "antd";
            ...
            >
                <Space direction="vertical" size="large" style={{ width: '100%' }}>
                    ...
                    >
                        ...
                        >
                            {technologies.map(tech => (
                                <Option key={tech.id} value={tech.techname}>{tech.techname}</Option>
                            ))}
                        </Select>
                    </Form.Item>
                    <Form.Item
                    ...
                    >
                        ...
                        >
                            {languages.map(lang => (
                                <Option key={lang.id} value={lang.programingname}>{lang.programingname}</Option>
                            ))}
                        </Select>
                    </Form.Item>
                    <Form.Item
