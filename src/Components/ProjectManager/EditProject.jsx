...
const EditProject = () => {
  ...
  const getStatusOptions = () => {
    ...
    if (currentStatus === "Pending" || currentStatus === "Ongoing") {
      return statusOptions.filter((option) => option.value !== "Not Started");
  ...
  return (
    <div>
      <BackButton />
      <h2 style={{ textAlign: "center" }}>{t("Edit Project")}</h2>
      {loading ? (
        <Spin size="large" />
      ) : (
        project && (
          <Form form={form} layout="vertical" onFinish={onFinish}>
            <Space direction="vertical" size="large" style={{ width: "100%" }}>
              <Form.Item
                ...
                label={t("Name")}
                rules={[
                  { required: true, message: t("Please input the name!") },
                ]}
              >
                <Input />
              </Form.Item>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("Please select the project duration!"),
                  },
                ]}
              >
